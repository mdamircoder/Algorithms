...
/* GCD of two positive integers, recursive*/
...
int GCD_Euclid_4 ( int max, int min ) // Type 4
{
	if (min==0)
		return max; // positive gcd
		
	return GCD_Euclid_1 ( min, max%min );
}

int main()
{
	cout << "1. GCD of 1024 and 36 is : " << GCD_Euclid_1(1024, 36) << endl ;
	...
	cout << "\n4. GCD of 102 and 312 is : " << GCD_Euclid_1(102, 312) ;
